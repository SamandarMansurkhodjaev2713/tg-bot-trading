# Create a completely clean version of the aitrader_command function
...
# Write to a new file to test
with open('aitrader_function.py', 'w', encoding='utf-8') as f:
    f.write(clean_function)

print("Created clean aitrader_command function")